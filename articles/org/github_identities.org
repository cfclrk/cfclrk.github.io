...
The source blocks in this program are tangled to my dotfiles repo at
[[https://github.com/cfclrk/dotfiles/tree/master/xdg_config/git][xdg_config/git]] and [[https://github.com/cfclrk/dotfiles/blob/master/.ssh/config][.ssh/config]].
