...
* The Git Config
  ...
  Ignore the =[github]= part, that's for [[https://github.com/magit/forge][Emacs forge]]. And of course, update the
  values for your name, email address, and -- if you're using [[#signed-commits]] --
  your PGP key id.
