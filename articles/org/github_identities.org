...
* The Problem
  ...
  My current config files are located at [[https://github.com/cfclrk/dotfiles/tree/master/xdg_config/git][xdg_config/git]] and [[https://github.com/cfclrk/dotfiles/blob/master/.ssh/config][.ssh/config]] on
  GitHub; they are generated from this article.
