...
#+begin_quote
This is out of date. Projectile has been updated to fix the issue presented
here. I'm temporarily keeping this as an example for myself about how to
...
* About Projectile Project Detection
  ...
  In our example, the second function -- =projectile-root-bottom-up= -- is the
  culprit. We can try it out interactively:
  ...
  That's useful, and works! Ok, we should retain that behavior. So what exactly
  are the problems we need to fix now?
...
* Solution
  ...
  /[[https://github.com/cfclrk/dotfiles/blob/master/emacs/projectile-discovery.el][Here is the Elisp file]] generated from this section (which I use in my
