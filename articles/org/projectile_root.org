...
* The Problem
  ...
  use Projectile on the whole monorepo by navigating to a file at the root of
  the monorepo.

  To jump to the solution, go to [[#solution]]. Or, see the Elisp file generated
  from this document [[https://github.com/cfclrk/dotfiles/blob/master/emacs/projectile-discovery.el][on GitHub]] (which I use in my personal Emacs config).
