...
* Characters
  ...
  Such syntax is necessary to distinguish the character like =à= from the symbol
  =à=.
...
* Convert code point to character
  ...
  The function =(char-to-string CHAR)= returns the character at the Unicode code
  point =CHAR=:
