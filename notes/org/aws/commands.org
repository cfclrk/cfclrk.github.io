...
* SSM
  ...
  :         "Type": "String",
  :         "Value": "ami-060e387c4a24f2434",
  :         "Version": 21,
  :         "LastModifiedDate": "2021-09-20T15:30:15.219000-04:00",
  :         "ARN": "arn:aws:ssm:us-east-2::parameter/aws/service/eks/optimized-ami/1.19/amazon-linux-2/recommended/image_id",
  :         "DataType": "text"
  :     }
  : }
...
** List Accounts I Can Access
   ...
   #+begin_src sh :var SsoToken=SsoToken
